...
def load_data(dir, max_examples, resize_height, resize_width, label, m_idx):
    ...
    for idx, i in enumerate(os.listdir(dir)):
        ...
        assert(data[m_idx,:,:].shape == img.transpose().shape) # asserts image matrix is of the intended shape, and fits data matrix
...
if __name__ == "__main__":
    curr_m_idx = 0
    data = np.empty((20, 500, 500), dtype=np.uint8)
    labels = []

    data, labels, m_idx = load_data('/home/nyscf/Desktop/Classification_Model/Initial_Training_Set/train/Colonies_Viable/Original', 500, 500, 500, 'viable', curr_m_idx)
    curr_m_idx = m_idx
    data, labels, m_idx = load_data('/home/nyscf/Desktop/Classification_Model/Initial_Training_Set/train/Colonies_Viable/rotate_90', 500, 500, 500, 'viable',curr_m_idx)
    curr_m_idx = m_idx
    ...
    data, labels, m_idx = load_data('/home/nyscf/Desktop/Classification_Model/Initial_Training_Set/train/Diff_And_Bad_Colonies/Original', 500, 500, 500, 'unviable',curr_m_idx)
    curr_m_idx = m_idx
    data, labels, m_idx = load_data('/home/nyscf/Desktop/Classification_Model/Initial_Training_Set/train/Diff_And_Bad_Colonies/rotate_90', 500, 500, 500, 'unviable',curr_m_idx)
    curr_m_idx = m_idx
